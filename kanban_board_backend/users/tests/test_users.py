...
class UserTests(APITestCase):
    ...
    def test_send_code_email(self):
        user = User.objects.create_user(username='codeuser', email='code@example.com', password='pass1234')
    ...
    def test_verify_code_success(self):
        user = User.objects.create_user(username='verifyuser', email='verify@example.com', password='pass1234')
    ...
    def test_verify_code_invalid(self):
        user = User.objects.create_user(username='invaliduser', email='invalid@example.com', password='pass1234')
        data = {
            'user_id': user.id,
            'purpose': 'email',
