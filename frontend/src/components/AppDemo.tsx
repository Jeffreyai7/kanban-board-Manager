      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-white">
            Experience the intuitive drag and drop interface that makes task
            management a breeze.
          </p>
        </div>
          ...
          <div className="flex justify-between items-center mb-6 pb-4 border-b">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-white">
                Sprint #24 • May 1 - May 14
              </p>
            </div>
            <div className="flex items-center space-x-2">
              <div className="flex -space-x-2">
                <div className="w-8 h-8 rounded-full bg-blue-500 dark:bg-blue-900 flex items-center justify-center text-white text-xs">
                  JD
                </div>
              ...
              <button
                title="icon"
                type="button"
                className="ml-2 bg-gray-100 p-2 rounded-lg hover:bg-gray-200 transition-colors"
              >
        ...
        <div className="max-w-3xl mx-auto text-center pt-30">
          ...
          <p className="text-gray-600 mb-8 dark:text-white">
            Whether you're managing software development, marketing campaigns,
            or HR processes, TaskCraft adapts to your team's unique workflow and
            requirements.
          </p>
